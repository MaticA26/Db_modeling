...
CREATE TABLE employee(
	...
	cnp CARCHAR(13) UNIQUE NOT NULL,
...
CREATE TABLE drona_projectie_senzori(
	project_id INTEGER NOT NULL,
	dorna_senzor_id INTEGER NOT NULL,
	PRIMARY KEY(projects_id, drona_senzor_id)
